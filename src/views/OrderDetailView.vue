...
const detailColumns: ColumnsType<JsonMap> = [
  ...
  { title: '交付数量', dataIndex: 'created_asn_qty', key: 'received_quantity' },
    { title: '在途数量', dataIndex: 'created_asn_qty', key: 'received_quantity' },
     { title: '未交数量', dataIndex: 'created_asn_qty', key: 'received_quantity' },
